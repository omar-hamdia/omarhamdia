  ...
  projects: [
    {
      ...
      description: "نظام متكامل لإدارة المكتبات يشمل إدارة الكتب، الأعضاء، عمليات الاستعارة والإرجاع، مع لوحة تحكم شاملة وتقارير مفصلة.",
      ...
      video: "video/Library_management.mp4",
      views_count: 156,
      average_rating: 4.5,
      ratings_count: 12,
    ...
    },
    {
      ...
      description: "نظام متكامل لإدارة الموظفين يشمل تتبع الحضور والغياب، إدارة الرواتب، وتنظيم بيانات الموظفين مع لوحة تحكم احترافية.",
      ...
      link: "#",
      github: "https://github.com/omarhamdia",
      video: "video/Staff_management.mp4",
      views_count: 89,
      average_rating: 4.8,
      ratings_count: 8,
      technologies: ["Laravel", "PHP", "MySQL", "Bootstrap"],
    ...
    },
    {
      ...
      description: "نظام شامل لإدارة المدارس يشمل إدارة الطلاب، المعلمين، الصفوف، الجداول الدراسية، والدرجات مع لوحة تحكم متكاملة.",
